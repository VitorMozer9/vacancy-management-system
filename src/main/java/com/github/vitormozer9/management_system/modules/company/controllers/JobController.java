...
public class JobController {
    ...
    @Tag(name = "Vancancies", description = "vancancies informations")
    @Operation(summary = "Create a new vancancy" , description = "This function is responsible for create a new vancancy")
    @ApiResponses({
