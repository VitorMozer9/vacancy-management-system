package com.github.vitormozer9.management_system.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        ...
        return new OpenAPI()
                .info(new Info().title("Vancancy Management System")
                        .description("Responsible API for vancancy management").version("1"))
